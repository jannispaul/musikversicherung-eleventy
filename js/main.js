...
var forms = function forms() {
  if (document.querySelector("#schaden-form") || document.querySelector("#anfrage-form")) {
    ...
    var reviewSubmitHandler = function reviewSubmitHandler(event) {
      console.log(event); // Add form .submitting state class for styling
    ...
    var submitHandler = function submitHandler(event) {
      if (storageID === "schaden-form" || storageID === "anfrage-form") {
        ...
        console.log(event); // Prevent default form submit
        ...
        var requestUrl = "";
        var redirectUrl = "";
        (_ref = storageID === "anfrage-form") !== null && _ref !== void 0 ? _ref : requestUrl = "https://www.formbackend.com/f/1cf344532f65848f";
        (_ref2 = storageID === "schaden-form") !== null && _ref2 !== void 0 ? _ref2 : requestUrl = "https://www.formbackend.com/f/706ac99a74b44def";
