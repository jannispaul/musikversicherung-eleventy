  ...
  if (document.querySelector("#schaden-form") || document.querySelector("#anfrage-form")) {
    ...
    var validateForm = function validateForm() {
      ...
      for (i = 0; i < requiredInputsInTab.length; i++) {
        ...
        if ( // if field is of type email and does not include an @
        requiredInputsInTab[i].type == "email" && !requiredInputsInTab[i].value.includes("@")) {
          // if field doesnt have invalid class
          if (!requiredInputsInTab[i].classList.contains("invalid")) {
            // add an "invalid" class to the field:
            requiredInputsInTab[i].classList.add("invalid");
        ...
        !requiredInputsInTab[i].value == "" && requiredInputsInTab[i].type != "checkbox" && requiredInputsInTab[i].type != "email" && requiredInputsInTab[i].classList.contains("invalid")) {
