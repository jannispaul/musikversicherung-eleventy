...
/* harmony import */ var _modules_anfrage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @modules/anfrage */ "./resources/js/modules/anfrage/index.js");
...
/***/ "./resources/js/modules/anfrage/index.js":
/*!***********************************************!*\
  !*** ./resources/js/modules/anfrage/index.js ***!
  \***********************************************/
...
var anfrage = function anfrage() {
  ...
  document.addEventListener("change", function (event) {
    ...
    var musikerhaftpflichtLabel = document.querySelector("div[data-musikerhaftpflicht]"); // let customOrganizationInput = document.querySelector(
  ...
  var submitHandler = function submitHandler(event) {
    ...
    fetch("https://1454459a-1de0-4477-9d83-6534dee946eb.mock.pstmn.io/v1", requestOptions).then(function (response) {
      ...
      if (response.ok) {
        ...
        window.location.href = "/anfrage-erfolgreich/"; // Clear saved formdata from localstorage
...
/* harmony default export */ __webpack_exports__["default"] = (anfrage);
...
var schadenMelden = function schadenMelden() {
  ...
  var storageID = document.querySelector("[data-auto-save]").id; // Methods
